...
- 所有者可：
  - 更改成员角色（readonly ↔ readwrite），使用 `t-select` 下拉选择。
...
| pages/member-manage/member-manage     | 成员管理（角色修改/移除/转让）           | t-list, t-avatar, t-tag, t-select, t-action-sheet, t-dialog                            |
