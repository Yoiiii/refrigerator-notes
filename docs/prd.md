...
- 设计风格：温暖家居风，主打家庭温馨感
- 主色：`#FF9F45`（暖橙），悬停/激活态 `#FF8A1F`
- 背景色：`#FAF8F5`（米白），卡片背景 `#FFFFFF`
- 圆角规范：卡片 24rpx，按钮 16rpx，输入框 12rpx
- 阴影规范：卡片阴影 0 8rpx 24rpx rgba(255,159,69,0.10)
- 字体：PingFang SC，正文 28rpx，辅助文字 24rpx
- 冰箱层视觉：大圆角抽屉造型，冷藏层浅蓝渐变，
  冷冻层深蓝渐变，状态色覆盖层背景
- 禁止：直角设计、纯白背景、过重的企业级视觉